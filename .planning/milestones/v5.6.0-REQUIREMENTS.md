# Requirements Archive: v5.6.0 Logging & Observability
...
- [x] **ERR-02**: MCP tool error handlers log errors to the structured logger — all catch blocks in server.js that return error status also call logger.error with stack trace
